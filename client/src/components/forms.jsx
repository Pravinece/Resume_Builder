...
export default function Form1({ handlenext }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:3001/cvupdate', formData)
      .then(response => {
...
export function Form2({ handlenext, handleprev }) {
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3001/cvupdate2', formData)
          .then(response => {
            console.log(response.data);
            handlenext();
          })
...
export function Form3({ handlenext, handleprev }) {
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3001/cvupdate3', formData)
          .then(response => {
            console.log(response.data);
            handlenext();
          })
...
export function Form4({ handlenext, handleprev }) {
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3001/cvupdate4', formData)
          .then(response => {
            console.log(response.data);
            handlenext();
          })
...
export function Form5({ handleprev }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:3001/cvupdate5', formData)
      .then(response => {
        console.log(response.data);
        navigate('/cv/1');
      })
